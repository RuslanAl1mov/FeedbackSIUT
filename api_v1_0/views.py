...
from app.models import Department, Subject, Teacher, TeacherSubject
...
class GetTeacherBySubjectIDAPIView(APIView):
    def get(self, request, *args, **kwargs):
        ...
        if subject_id is not None:
            teachers_sbjects = TeacherSubject.objects.filter(subject_id=subject_id)
            teachers_list = []
            for sbj in teachers_sbjects:
